...
CowTimer hi = new CowTimer();
String bye = JOptionPane.showInputDialog("What would you like to set the timer to? (Please use numbers)");
int x = Integer.parseInt(bye);
hi.setTime(x);
hi.start();
	}
